...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_c', type=int, default=4)
    ...
    parser.add_argument('--dataset', type=str, default='l9b1')
    parser.add_argument('--mode', type=str, default='test', choices=['train', 'test', 'memory_initial'])
    parser.add_argument('--data_path', type=str, default='./data_factory/SIM/l9b1/')
    ...
    parser.add_argument('--memory_initial',type=str, default="True", help='whether it requires memory item embeddings. False: using random initialization, True: using customized intialization')
    parser.add_argument('--phase_type',type=str, default="test", help='whether it requires memory item embeddings. False: using random initialization, True: using customized intialization')
